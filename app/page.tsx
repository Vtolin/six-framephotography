            ...
            <div className="max-w-5xl mx-auto text-center text-white">
              ...
              <Animated animation="fade-in" delay={800}>
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
                  <button className="group relative overflow-hidden bg-white text-black px-6 sm:px-8 py-3 sm:py-4 text-sm font-medium tracking-wider uppercase transition-all duration-300 hover:-translate-y-1 hover:shadow-xl min-h-11">
                  ...
                  <button className="group border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 text-sm font-medium tracking-wider uppercase transition-all duration-300 hover:bg-white hover:text-black hover:-translate-y-1 min-h-11">
                    Hubungi Kami
                  </button>
                </div>
              </Animated>
            ...
            <div className="order-2 md:order-1">
              ...
              <Animated animation="fade-up" delay={200}>
                <p className="text-gray-600 leading-relaxed text-lg mb-6">
                  Kami adalah studio fotografi dan videografi butik yang berfokus pada pengabadian momen-momen berharga. Mulai dari pernikahan intim hingga acara motorsport komersial, kami memadukan keahlian teknis dengan visi artistik.
                </p>
              </Animated>

              <Animated animation="fade-up" delay={400}>
                <p className="text-gray-600 leading-relaxed text-lg mb-8">
                  Setiap karya dibuat dengan niat, emosi, dan komitmen penuh terhadap kualitas untuk menceritakan kisah Anda secara autentik dan berkelas.
                </p>
              </Animated>

              <Animated animation="fade-up" delay={600}>
                <button className="group inline-flex items-center text-gray-900 font-medium pb-2 border-b-2 border-gray-900 transition-all hover:text-gray-600 hover:border-gray-600">
            ...
            <Animated animation="fade-up" delay={0}>
              <div className="text-center mb-12 md:mb-16">
                ...
                <p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto">
                 Solusi visual menyeluruh yang disesuaikan dengan kebutuhan Anda
                </p>
              </div>
            </Animated>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              {[
                { 
                  ...
                  desc: "Foto romantis, natural, dan timeless untuk hari istimewa Anda",
                  price: "Mulai dari Rp700,000"
                },
                { 
                  title: "Videografi", 
                  desc: "Film sinematik yang menghidupkan momen",
                  price: "Mulai dari Rp1,000,000"
                },
                { 
                  title: "Sesi Potret", 
                  desc: "Branding pribadi, keluarga, dan gaya hidup",
                  price: "Mulai dari Rp400,000"
                },
                { 
                  title: "Acara & Event", 
                  desc: "Acara selebrasi dan perayaan spesial",
                  price: "Mulai dari Rp900,000"
                },
                { 
                  title: "Liputan Motorsport", 
                  desc: "Liputan profesional terfokus untuk event balap & otomotif",
